...
BLOG_AUTHOR = "mithrandi"  # (translatable)
...
BLOG_EMAIL = "mithrandi@mithrandi.net"
BLOG_DESCRIPTION = "the shards of meaning"  # (translatable)
...
TWITTER_CARD = {
    ...
    'site': '@mithrandi',       # twitter nick for the website
    'creator': '@mithrandi',    # Username for the content creator / author.
}
